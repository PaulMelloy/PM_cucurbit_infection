...
the willingness of the model implies it might be over-fit, especially between the 
...
test_dat <- data.table(Tm = rep(seq(from = 5, to = 40, by = 0.1), 4), # between 5 and 8 degrees for each incubation period
                        i_period = rep(c(12,24,36,48), each = length(seq(from = 5, to = 40, by = 0.1))))
...
We can use stacked bars to show not only the number of germ tubes.  
