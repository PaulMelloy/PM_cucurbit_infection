...
tm_b <- rbind(tm_b,zero_branch)[order(Tm,branchs, rep)]

fwrite(tm_b, "cache/Tm_branching.csv")
```
...
```{r clean_germ_tm}
# Remove unnecessary columns and rows
br_vpd_tm <- br_vpd_tm[-c(5:10,15:24),-c(1,2,9:12,19:22,29)][-c(13)]
...
br_vpd_tm[ , Tm := rep(c(22,25,28), each = 4)]
...
br_vpd_tm[, c("vpd","branches") := tstrsplit(variable, "_b")][, variable := NULL]

# Change column order
setcolorder(br_vpd_tm,
