...
# Change column order
setcolorder(br_vpd,
            neworder = c("vpd","RH", "Tm", "branches","conidia"))
...
zero_branch <- br_vpd[, (100 - sum(conidia)), 
                      by = .(vpd,RH,Tm, rep)][,branches :=0][, .(vpd,RH, Tm, branches, rep, V1)]
...
zero_branch <- br_vpd2[, (100 - sum(conidia)), 
                      by = .(Tm, RH,vpd, rep)][,branches :=0][, .(vpd,RH,Tm, branches, rep, V1)]
...
# Change column order
setcolorder(br_vpd2,
            neworder = c("vpd", "RH","Tm", "branches","rep","conidia"))
